...
BEGIN
    ...
    -- ========================================================================
    -- CRITICAL: Use the GREATER of sale-level discount vs item-level discount sum
    ...
    RAISE NOTICE 'Updated sale % totals: subtotal=%, discount=%(item=%,sale=%), tax=%, total=%, cost=%, profit=%', 
        p_sale_id, v_subtotal, v_total_discount, v_item_discount, v_sale_discount, v_tax_amount, v_total_amount, v_total_cost, v_profit;
END;
$$ LANGUAGE plpgsql;
